...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Accede al panel DEVI para gestionar pacientes y citas.",
      },
...
function Index() {
  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden px-4 py-10 text-neutral-100 bg-[url('/fondo.jpg')] bg-cover bg-center bg-no-repeat">
      {/* Ambient glow */}
      <div
        className="pointer-events-none absolute -top-32 left-1/2 h-96 w-[42rem] -translate-x-1/2 rounded-full opacity-40 blur-3xl"
        style={{
          background: "radial-gradient(closest-side, #c9a84c55, transparent)",
        }}
      />
        ...
        <div className="mb-8 text-center">
          <h1
            ...
            style={{
              ...
              color: "#f0d78c",
              textShadow: "0 0 18px #c9a84c66",
            }}
          >
            DEV-I
          </h1>
          <p
            className="mt-2 text-xs uppercase tracking-[0.4em] text-[#c9a84c]/70"
        ...
        <div className="devi-hud-corner rounded-2xl border border-[#c9a84c]/25 bg-neutral-950/70 p-8 backdrop-blur-xl shadow-[0_30px_80px_-30px_#000,0_0_40px_-20px_#c9a84c88]">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div className="space-y-2">
              <Label
                htmlFor="user"
                className="text-xs uppercase tracking-widest text-[#c9a84c]/80"
              >
                Correo o usuario
              </Label>
        ...
        <DialogContent className="border-[#c9a84c]/30 bg-neutral-950 text-neutral-100">
          <DialogHeader>
            ...
            <DialogDescription className="text-neutral-400">
              ...
              contraseña. (Función próximamente en esta demo.)
            </DialogDescription>
          </DialogHeader>
          <Input
            placeholder="tu-correo@devi.com"
            className="border-[#c9a84c]/25 bg-black/50 text-neutral-100"
          />
          <DialogFooter>
            <Button
              variant="ghost"
